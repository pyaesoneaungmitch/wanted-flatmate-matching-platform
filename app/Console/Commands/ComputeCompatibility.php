...
class ComputeCompatibility extends Command
{
    protected $signature = 'compat:compute {--user_id=}';
    protected $description = 'Compute compatibility scores (0-100) from latest quiz responses and store in compatibility table';

    public function handle(): int
    {
        // 1) Pull each user's latest quiz response
        ...
        // Store only ordered pairs (min, max) to avoid duplicates.
        $rowsUpserted = 0;
